...
export default function BlocklyEditor() {
    ...
    return (
        <Paper sx={{ p: 2, height: 'calc(100vh - 150px)', display: 'flex', flexDirection: 'column', backgroundColor: 'background.default' }}>
            ...
            <Grid container spacing={2} sx={{ flexGrow: 1, minHeight: 0 }}>
                ...
                <Grid item xs={12} md={8}>
                    <Box sx={{ height: '100%', border: '2px solid #DDDDDD', borderRadius: 2, overflow: 'hidden', boxShadow: '0 4px 6px rgba(0,0,0,0.1)' }}>
                ...
                <Grid item xs={12} md={4}>
                    <Box sx={{
                        height: '100%', backgroundColor: '#F8F9FA', color: '#736372', border: '1px solid #DDDDDD', p: 2, borderRadius: 2,
