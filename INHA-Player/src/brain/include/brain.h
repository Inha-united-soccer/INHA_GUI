...
public:
    ...
    void registerGoalieDecisionNodes(BT::BehaviorTreeFactory &factory){RegisterGoalieDecisionNodes(factory, this);}
    void registerRoleManager(BT::BehaviorTreeFactory &factory){RegisterRoleManager(factory, this);}
    void registerPassNodes(BT::BehaviorTreeFactory &factory){RegisterPassNodes(factory, this);}
